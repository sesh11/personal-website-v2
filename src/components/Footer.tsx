  ...
  return (
    <div className="flex justify-center gap-8 py-8 mt-8">
      <a
        ...
        title="LinkedIn"
        className="inline-flex items-center justify-center w-10 h-10 rounded-full bg-gray-100 text-gray-700 transition-all duration-300 hover:-translate-y-0.5 hover:bg-gray-200"
      >
        <svg
