...
The natural transition from here is general-purpose agents, agents that take on more work, reason across multiple systems, and run over long horizons. There are primarily two reasons for this:
